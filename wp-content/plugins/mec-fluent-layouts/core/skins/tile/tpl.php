...
if($this->next_previous_button)
{
    ...
    {
        $navigator_html .= '<div class="mec-previous-month mec-load-month mec-previous-month" data-mec-year="'.date('Y', $_1month_before).'" data-mec-month="'.date('m', $_1month_before).'"><i class="mec-sl-angle-left"></i></div>';
    }
    ...
    {
        $navigator_html .= '<div class="mec-next-month mec-load-month mec-next-month" data-mec-year="'.date('Y', $_1month_after).'" data-mec-month="'.date('m', $_1month_after).'"><i class="mec-sl-angle-right"></i></div>';
    }
}
...
<div id="mec_skin_<?php echo $this->id; ?>" class="mec-wrap mec-fluent-wrap mec-skin-tile-container <?php echo $event_colorskin . ' ' . $this->html_class . ' ' . $set_dark; ?>">    
    <?php if($this->next_previous_button) : ?>
        <div class="mec-skin-tile-month-navigator-container mec-calendar-a-month">
