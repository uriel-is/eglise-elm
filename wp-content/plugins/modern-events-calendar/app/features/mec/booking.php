                            ...
                            <div class="mec-container">
                                ...
                                <div class="mec-form-row" style="margin-bottom: 30px;">
                                    <div class="mec-col-12">
                                        ...
                                        <p><?php esc_html_e("By enabling this feature, tickets will be added to WC cart and all payment process would be done by WooCommerce so all of MEC payment related modules will be disabled. To configure your desired gateways and booking fields etc, you need to configure WooCommerce on your website.", 'mec'); ?></p>
                                        <div id="mec_gateways_wc_status_guide" class="<?php if(!isset($settings['wc_status']) or (isset($settings['wc_status']) and !$settings['wc_status'])) echo 'w-hidden'; ?>">
                                            ...
                                            <div class="mec-form-row">
                                                <label class="mec-col-3" for="mec_gateways_wc_autoorder_complete"><?php _e('Automatically complete WC orders', 'mec'); ?></label>
                                                <div class="mec-col-4">
