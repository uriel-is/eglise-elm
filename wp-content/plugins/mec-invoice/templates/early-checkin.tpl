...
<head>
    ...
    <style>
        ...
        .mec-qrcode-ticket-content-box p {
            font-size: 15px;
            margin: 0;
            color: #fff;
            margin-top: 10px;
    ...
    <div class="mec-qrcode-content-wrap">
        <div class="mec-qrcode-content">
            ...
            <div class="mec-qrcode-ticket-content-box">
                <h3>[[This is too early for check-in.]]</h3>
                <p>
                    [[The event has not started yet. If you are sure about this please contact the website administrator.]]
                </p>
            </div>
        </div>
    </div>
