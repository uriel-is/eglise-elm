...
<head>
    ...
    <style>
        ...
        .mec-qrcode-successfull-notice {
            ...
            background-image: linear-gradient(135deg, #25de80 0%, #15bbcc 45%, #49d5dc 100%);
            padding: 0;
            margin: 0;
        }
    ...
    <div class="mec-qrcode-content-wrap">
        <div class="mec-qrcode-content">
            ...
            <div class="mec-qrcode-ticket-button">
                <a href="{{CheckUrl}}">[[Check Ticket]]</a>
            </div>
        </div>
    </div>
</body>
