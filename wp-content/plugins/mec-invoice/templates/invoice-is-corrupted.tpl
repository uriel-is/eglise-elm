...
<head>
    ...
    <style>
        ...
        .mec-qrcode-successfull-notice {
            ...
            background-image: linear-gradient(135deg, #FF7E7E 0%, #FF0844 45%, #FF0844 100%);
        }
    ...
    <div class="mec-qrcode-content-wrap">
        <div class="mec-qrcode-content">
            <div class="mec-qrcode-ticket-number-box">
                ...
                <div class="mec-qrcode-ticket-number-text"><span>[[OoO!]]</span><span>[[Bad Situation]]</span></div>
            </div>
            <div class="mec-qrcode-ticket-content-box">
                <h3 style="font-size: 40px;">[[Invoice Data is Missed!]]</h3>
            </div>
        </div>
    </div>
</body>
