...
<head>
    ...
    <title>[[Successfully Unchecked]]</title>
    <style>
        body {
        ...
        .mec-qrcode-successfull-notice {
            ...
            background-image: linear-gradient(135deg, #b0dc45 0%, #82a519 45%, #ad9f03 100%);
            padding: 0;
            margin: 0;
        }
    ...
    <div class="mec-qrcode-content-wrap">
        <div class="mec-qrcode-content">
            ...
            <div class="mec-qrcode-ticket-content-box">
                <h3 class="mec-qrcode-unchecked">[[Successfully Unchecked]]</h3>
