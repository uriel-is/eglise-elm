...
<h2 class="bp-screen-reader-text"><?php
	...
	_e( 'Profile visibility settings', 'deep' );
?></h2>
...
<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standard-form" id="settings-form">
				...
				<table class="profile-settings" id="xprofile-settings-<?php bp_the_profile_group_slug(); ?>">
					<thead>
						<tr>
							...
							<th class="title"><?php _e( 'Visibility', 'deep' ); ?></th>
						</tr>
					</thead>
					...
					<tbody>
						...
						<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
							...
							<tr <?php bp_field_css_class(); ?>>
								<td class="field-name"><?php bp_the_profile_field_name(); ?><span class="dp-bd-setting-pro"></span></td>
	...
	<div class="submit">
		<input id="submit" type="submit" name="xprofile-settings-submit" value="<?php esc_attr_e( 'Save Settings', 'deep' ); ?>" class="auto" />
	</div>
