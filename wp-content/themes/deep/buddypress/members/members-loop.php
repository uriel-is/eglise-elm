...
<?php if ( bp_has_members( bp_ajax_querystring( 'members' ) ) ) : ?>
	...
	<ul id="members-list" class="item-list wn-isotope" aria-live="assertive" aria-relevant="all">

	<?php while ( bp_members() ) : bp_the_member(); ?>

		<li class="wn-masonry-item"<?php bp_member_class(); ?>>
			<div class="wn-member-inner-list">
				...
				<div class="action">
					...
					<button class="wn-dropdown-btn"><i class="icon-arrows-down"></i></button>
					<div class="wn-dropdown"><div class="wn-dropdown-content"></div></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( "Sorry, no members were found.", 'deep' ); ?></p>
	</div>
