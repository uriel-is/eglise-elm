...
<?php if( 'left' == $deep_options['michigan_webnus_blog_singlepost_sidebar'] ){ ?>
	<aside class="col-md-3 sidebar leftside">
		<?php if(is_active_sidebar('Left Sidebar')) dynamic_sidebar( 'Left Sidebar' ); ?>
	</aside>
<?php } ?>
	<div class="<?php echo ( 'none' == $deep_options['michigan_webnus_blog_singlepost_sidebar']  )?'col-md-12':'col-md-9 cntt-w'?>">
		...
		<div class="container">
			<section class="col-md-12">
				<?php if( have_posts() ): while( have_posts() ): the_post();  ?>
					...
					<?php
					if(  $deep_options['michigan_webnus_blog_sinlge_featuredimage_enable'] && !isset($background) ){
					...
					<?php } ?>
						...
						<div <?php post_class('post'); ?>>
							<div class="postmetadata">
								<?php if($deep_options['michigan_webnus_blog_meta_category_enable']){ ?>
	...
	<?php if($deep_options['michigan_webnus_blog_singlepost_sidebar'] == 'right' ){ ?>
