...
<div class="archive-course-wrap clearfix">
    ...
    <main class="container content llms-content w-course-archive">
        ...
        if ( have_posts() ){
                ...
                <article class="w-course-list">
                    ...
                    <div class="col-md-8 none-grid">
                        <div class="course-list-content">
                            ...
                            <?php
                            $course_price = deep_michigan_course_price();
                            echo ($course_price)?'<div class="course-list-price">'.$course_price.'</div>':'';
                            echo '<p>'.deep_excerpt(36).'</p>';
                            if($deep_options['michigan_webnus_course_taking']==1 && is_plugin_active('lifterlms/lifterlms.php')){
                                llms_get_template( 'course/purchase-link.php' );
                            }elseif($deep_options['michigan_webnus_course_taking']==2){
                                echo '<br><a href="'.$deep_options['michigan_webnus_course_taking_custom'].'" class="llms-button" target="_self">'.esc_html__('Take This Course','deep').'</a>';
                            }?>
                        </div>
                    </div>
                    </div>
            ...
            echo '<p class="lifterlms-info">'._e( 'No products were found to match your selection.', 'deep' ) .'</p>';
        }
