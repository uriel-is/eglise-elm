			...
			<div class="vc_carousel-inner">
				<div class="vc_carousel-slideline">
					<div class="vc_carousel-slideline-inner">
						...
						$block_style = isset( $post->bgcolor ) ? ' .vc_item-' . $uniqid . '{ background-color: ' . $post->bgcolor . '}' : '';
						deep_save_dyn_styles( $block_style );
						?>
						<div class="vc_item vc_item-<?php echo '' . $uniqid; ?> vc_slide_<?php echo esc_attr( $post->post_type ) ?>">
							<div class="vc_inner">
