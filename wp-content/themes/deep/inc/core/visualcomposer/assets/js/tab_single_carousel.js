    ...
    render:function () {
	   ...
	   ready:function (e) {
        ...
        cloneModel:function (model, parent_id, save_order) {
            ...
            if (model.get('shortcode') === 'content_carousel_tab') _.extend(new_params, {tab_id:+new Date() + '-' + this.$tabs.find('[data-element_type=content_carousel_tab]').length + '-' + Math.floor(Math.random() * 11)});
