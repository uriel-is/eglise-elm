    ...
    */
    ...
    final class Webnus_Elementor_Extentions {
        ...
        public function __construct() {
            ...
            add_action( 'elementor/editor/after_enqueue_scripts', [$this, 'preview_script'] );
        ...
        public function init() {
            ...
            include 'section-template/source.php';
            include 'section-template/template-manager.php';
        ...
        */
        public static function preview_script() {
            wp_enqueue_script( 'deep-ele-templates', DEEP_ASSETS_URL . 'js/backend/elementor-section-template.js', array('jquery'), DEEP_VERSION, true );
        }
        /**
         * Registe Widgets
         *
