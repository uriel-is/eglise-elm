...
if ( ! function_exists( 'deep_woo_get_ajax_info' ) ) {
    function deep_woo_get_ajax_info() {
        ...
        $post_url = isset ($_POST['url']) ? $_POST['url'] : $shop_page_url ;
...
// if ( ! function_exists( 'deep_woo_get_cat_info' ) ) {
//     function deep_woo_get_cat_info() {
//         $post_url = isset ($_POST['url']) ? $_POST['url'] : '' ;
...
if ( is_plugin_active( 'yith-woocommerce-wishlist/init.php' ) ) {
    ...
    function deep_remove_from_wishlist_ajax () {
        ...
        $prod_id = isset( $_POST['proid'] )  ? $_POST['proid'] : false;
...
/**
    ...
    if ( ! function_exists( 'deep_woo_save_metabox' ) ) {
        ...
        function deep_woo_save_metabox( $post_id ) {
            ...
            $deep_so_offer_finish_text = isset( $_POST['_deep_offer_finish_text'] ) ? $_POST['_deep_offer_finish_text'] : '';
            update_post_meta( $post_id, '_deep_offer_finish_text', $deep_so_offer_finish_text );

            $deep_featured_video = isset( $_POST['_deep_featured_video'] ) ? $_POST['_deep_featured_video'] : '';
            update_post_meta( $post_id, '_deep_featured_video', $deep_featured_video );

            $deep_featured_text = isset( $_POST['_deep_featured_text'] ) ? $_POST['_deep_featured_text'] : '';
...
if ( ! function_exists( 'deep_woo_yith_woocompare_popup_head' ) ) :
    function deep_woo_yith_woocompare_popup_head() {
        ...
        echo '<link rel="stylesheet" href="' . DEEP_ASSETS_URL . 'css/frontend/base/07-iconfonts.css"/>';
