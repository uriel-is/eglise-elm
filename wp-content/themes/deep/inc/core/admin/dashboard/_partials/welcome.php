...
<div class="wrap about-wrap wn-admin-wrap">
	...
	$check_version = wp_remote_get( 'http://webnus.biz/webnus.net/theme-api/version' );		
	$update_version = json_decode(wp_remote_retrieve_body($check_version));	
			...
			<div class="w-row">
				<div class="w-col-sm-12">
					<div class="w-box theme-activate">
						...
						<?php 
						if ( $theme_version < $update_version->version ) { ?>
							<div class="w-box-content update-now-box">
								<?php echo esc_html__('New version available (v  '. $update_version->version .' )' , 'deep'); ?>																
								<a href="<?php echo admin_url( 'update-core.php'); ?>" class="button-link">Update now</a>								
							</div>
						<?php } ?>
					</div>
				</div>
				...
				<div class="w-col-sm-6">
					<div class="w-box support">
						...
						<div class="w-box-content">
							...
							<div class="w-button">
								<a href="#" id="open-ticket"><?php esc_html_e('OPEN A TICKET','deep'); ?></a>
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		window.fwSettings={ 'widget_id':47000002173 };
	...
	<script type='text/javascript' src='https://widget.freshworks.com/widgets/47000002173.js' async defer></script>
