	...
	<div class="whb-modal-contents-wrap">
		<div class="whb-modal-contents wp-clearfix">
			...
			<div class="whb-elements-item w-col-sm-4" data-element="lifterlms-search-form">
				<a href="#"><i class="ti-search"></i><span class="whb-element-name"><?php esc_html_e( 'Lifterlms search form', 'deep' ); ?></span></a>
			</div>

			<!-- Menu Location -->
			<!-- <div class="whb-elements-item w-col-sm-4" data-element="menu-location">
				<a href="#"><i class="ti-menu"></i><span class="whb-element-name"><?php esc_html_e( 'Menu Location', 'deep' ); ?></span></a>			
			</div> -->
