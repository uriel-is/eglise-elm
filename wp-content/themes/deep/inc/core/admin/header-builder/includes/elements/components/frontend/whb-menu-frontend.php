		...
		if ( ! empty( $menu ) && is_nav_menu( $menu ) ) {
			...
			$menu_out = '
				<div class="whb-element">
					<span>' . esc_html__( 'Your menu is empty or not selected! ', 'deep' ) . '<a href="https://webnus.net/deep-premium-wordpress-theme-documentation/menu/" class="sf-with-ul hcolorf" target="_blank">' . esc_html__( 'How to config a menu', 'deep' ) . '</a></span>
				</div>
			';
