	...
	<div class="extensions wp-clearfix">
		...
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>MB Rest API</h3>
					<p><?php esc_html_e( 'Pull all meta values from posts, terms into the WP REST API responses.', 'meta-box' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
		...
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					...
					<p><?php esc_html_e( 'Automatically and instantly populate location data with the power of Google Mapss Geolocation API.', 'meta-box' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
		...
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					...
					<p><?php esc_html_e( 'Add content of custom fields to Yoast SEO Content Analysis to have better/correct SEO scores.', 'meta-box' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
		...
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					...
					<p><?php esc_html_e( 'Show or hide meta boxes whenever and for whoever you choose.', 'meta-box' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
