...
class RWMB_Map_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		/**
		 * Since June 2016, Google Mapss requires a valid API key.
		 *
	...
	public static function normalize( $field ) {
		...
		$field = wp_parse_args( $field, array(
			...
			// Default API key, required by Google Mapss since June 2016.
	...
	public static function render_map( $location, $args = array() ) {
		...
		/*
		 * Google Mapss options.
		 * Option name is the same as specified in Google Mapss documentation.
