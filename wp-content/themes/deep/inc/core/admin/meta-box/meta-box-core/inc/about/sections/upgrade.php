...
<div class="upgrade">
	...
	<ul>
		<li><svg class="icon"><use xlink:href="#checkmark-outline"></use></svg><?php esc_html_e( 'Create custom fields with drag-and-drop interface - no coding knowledge required!', 'meta-box' ); ?></li>
