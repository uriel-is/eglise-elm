...
<div id="support" class="gt-tab-pane">
	...
	<div class="feature-section two-col">
		<div class="col">
			...
			<p><?php esc_html_e( 'If you have any question about using the plugin, please open a new topic on WordPress.org support forum or open a new issue on Github (preferable). We will try to answer as soon as we can.', 'meta-box' ); ?><p>
