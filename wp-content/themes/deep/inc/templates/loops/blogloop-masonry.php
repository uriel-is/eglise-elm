...
<article  class="pin-box entry -item">
	...
	<div class="pin-ecxt">
		...
		echo '<p>' . deep_excerpt( ( $deep_options['deep_blog_excerpt_list'] ) ? $deep_options['deep_blog_excerpt_list'] : 31 ) . '</p>';
		if ( $post_format == 'quote' ) {
			echo '</blockquote>';
		}
	...
	<div class="pin-ecxt2">
		<div class="col1-3"><a class="hcolorf" href="<?php echo get_comments_link(); ?>"><i class="wn-far wn-fa-comment"></i><span><?php echo get_comments_number(); ?></span></a></div>
