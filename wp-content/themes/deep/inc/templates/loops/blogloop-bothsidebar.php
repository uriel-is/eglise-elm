...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
	...
	<div class="postmetadata">
		...
		if( 1 == $deep_options['deep_blog_meta_author_enable'] ) { ?>
			<h6 class="blog-author"><strong><?php esc_html_e('by','deep'); ?></strong> <?php the_author_posts_link(); ?> </h6>
			<?php
		}
		if( 1 == $deep_options['deep_blog_meta_category_enable'] ) { ?>
			<h6 class="blog-cat"><strong><?php esc_html_e('in','deep'); ?></strong> <?php the_category(', ') ?> </h6>
			<?php
		}
		if( 1 == $deep_options['deep_blog_meta_comments_enable'] ) { ?>
			<h6 class="blog-comments"><a class="hcolorf" href="<?php echo get_comments_link();?>"><strong> - </strong> <?php comments_number(  ); ?></a></h6>
			<?php
		} ?>
	</div>
