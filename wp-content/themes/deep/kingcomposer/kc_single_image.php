...
if ( ! empty( $alt ) ) {
	...
	$image_attributes[] = 'alt="default image"';
}
...
} elseif ( $on_click_action == 'open_custom_link' ) {
...
<div <?php echo implode( ' ', $element_attributes ); ?> id="wpb_single_image<?php echo esc_attr( $uniqid ); ?>">
	<?php
	...
	<a <?php echo esc_attr( $data_lightbox ); ?> href="<?php echo esc_attr( $image_full ); ?>" title="<?php echo strip_tags( $title_link ); ?>" target="<?php echo esc_attr( $target ); ?>">
		<img <?php echo implode( ' ', $image_attributes ); ?> /><?php wp_kses_post( $html ); ?>
	</a>
		<?php
	} else {
		?>
