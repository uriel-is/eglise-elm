...
$course_features = $deep_options['michigan_webnus_course_features'];
?>
...
<?php
	if($deep_options['michigan_webnus_enable_breadcrumbs'] ) {
		...
		echo '<div class="breadcrumbs-w"><div class="container"><div id="crumbs"><a href="'.$homeLink.'">'.esc_html__('Home','deep').'</a> <i class="fa-angle-right"></i><a href="' . $homeLink .  $post_type->rewrite['slug'] . '/">' . $post_type->labels->name . '</a> <i class="fa-angle-right"></i> <span class="current">'.get_the_title().'</span></div></div></div>';
	}
?>
